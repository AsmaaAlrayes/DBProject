...
//  ProjectDB
//
//  Created by Asmaa Alrayes on 11/21/18.
//  Copyright © 2018 Asmaa Alrayes. All rights reserved.
//

import UIKit
import FirebaseDatabase
class dishesViewController: ViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        tableDishes.delegate = self
        tableDishes.dataSource = self
    }
